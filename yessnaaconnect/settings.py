"""
Django settings for yessnaaconnect project.
...
SECRET_KEY = os.environ.get('DJANGO_SECRET_KEY', 'django-insecure-+lxzy1i9g#m8pm_6^53a(ef7^i^b32fks)-pt2!4%n5o+bgq00')
